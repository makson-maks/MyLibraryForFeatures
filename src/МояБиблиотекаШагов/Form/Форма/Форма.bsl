...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯУдаляюВсеЭлементыДокумента(Парам01)","ЯУдаляюВсеЭлементыДокумента","И я удаляю все элементы Документа ""ПриходДенежныхСредств""","","");
...
Процедура ЯУдаляюВсеЭлементыДокумента(Парам01) Экспорт
